...
window.ReleaseScheduleData = {
    ...
    autoGenerateCharacters: [
        ...
        { version: "4.6.2", characters: ["후카"], days: 14 },
        { version: "4.7.1", characters: ["쇼키·암야"], "main-story": "5-4", persona: ["마카브르"], weapon_stamp: ["크리스탈 트레저"], mindscape_core: ["토모코·여름", "유우미", "YUI"], note: "Janosik IV", days: 14 },
        { version: "4.7.1", characters: ["슌·프론티어"], note: "Desire Gallery Mission (Mindscape Core Dungeon)", mindscape_core: ["J&C"], days: 14 },
        { version: "4.7.2", characters: ["준페이"], days: 14 },
        { version: "4.8.1", characters: ["나루미"], mindscape_core: ["렌", "야오링·사자무"], revelation: ["순수", "타락", "강인"], weapon_stamp: ["천상의 별"], days: 14 },
        { version: "4.8.2", characters: ["코로마루"], days: 14  },
