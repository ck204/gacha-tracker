...
window.ReleaseScheduleData = {
    ...
    autoGenerateCharacters: [
        ...
        { version: "4.4(5.2.1)", date: "2026-06-25", characters: ["미쿠"], goldTicketUnlocks: ["CHERISH"], note: "Worldwide Simultaneous Release", days: 21 },
        ...
        { version: "4.5",  date: "2026-07-16", characters: ["미나미·여름"], "summer": true, days: 21 },
        { version: "4.6", date: "2026-07-30", characters: ["미유·여름"], "summer": true, persona: ["사히모치노카미"], weapon: ["설원의 침묵"], days: 14 },
        { version: "4.7(4.2)", date: "2026-08-13", characters: ["이치고"], "main-story": "5-2",  goldTicketUnlocks: ["HOWLER"], persona: ["트럼페터", "바스키"], weapon: ["망령의 저주"], days:14 },
        { version: "4.8(4.4)", date: "2026-08-27", characters: ["카타야마"],  rev_set:["희망","변화"], days: 14 },
        { version: "4.9(4.5)", date: "2026-09-09",characters: ["YUI·스텔라"], "main-story": "5-3", weapon: ["엔트로피·제로"], revelation: ["예리", "풍족", "획득"], days: 14 },
        { version: "4.10(5.4.1)", date: "2026-09-24", characters: ["코토네"], collaboration: "p3p",  rev_set:["탄생","분쟁"], note: "Worldwide Simultaneous Release", days: 21 },
        { version: "4.11(4.6.1)", date: "2026-10-15",characters: ["미츠루"], days: 14 },
        { version: "4.12(4.6.2)", characters: ["후카"], days: 14 },
        { version: "4.13(4.7.1)", characters: ["쇼키·암야"], "main-story": "5-4", persona: ["마카브르"],  goldTicketUnlocks: ["TURBO"], weapon_stamp: ["크리스탈 트레저"], mindscape_core: ["토모코·여름", "유우미", "YUI"], note: "Janosik IV", days: 14 },
        { version: "4.13(4.7.1)", characters: ["슌·프론티어"], note: "Desire Gallery Mission (Mindscape Core Dungeon)", days: 14 },
        { version: "4.14(4.7.2)", characters: ["준페이"], mindscape_core: ["J&C"], days: 14 },
        { version: "4.15(4.8.1)", characters: ["나루미"], mindscape_core: ["렌", "야오링·사자무"], revelation: ["순수", "타락", "강인"], weapon_stamp: ["천상의 별"], days: 14 },
        { version: "4.16(4.8.2)", characters: ["코로마루"], rev_set:["예리","방해"], days: 14  },
        ...
        { version: "5.3.1", characters: ["아야카·여름"], days: 14, "summer": true, mindscape_core: ["모토하·여름"], revelation: ["반성", "기쁨"],  rev_set:["자아","반성"], weapon:["속삭이는 자의 가시"]},
        { version: "5.3.2", characters: ["이치고·여름"], days: 14, "summer": true, mindscape_core: ["하루"], rev_set:["돌파","기쁨"]},
        { version: "5.4.2", characters: [""], days: 14,  limitTransitions: [{ from: true, to: false, characters: ["아야카", "마코토"] }]},
        // --- 예정이지만 언제 나올지 모르는 것들 ---
